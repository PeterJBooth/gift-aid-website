    ...
    <>
      <ScreenTypeContextProvider>
        ...
        <main>
          ...
          <div className=" mx-auto mt-40  flex max-w-10xl items-center justify-center px-custom">
            ...
            <div className="hidden w-1/12 desktop:flex"></div>

            <div className="box-border hidden w-2/6 min-w-60 items-center justify-center desktop:flex">
              <img
                src={assumptionIcon}
                className=" mb-4 w-64"
                alt="Assumption Icon"
          ...
          <div className="mx-auto mb-40 mt-52 flex max-w-[35rem] flex-col items-center justify-center gap-12  px-custom largeDesktop:w-[45rem]">
            <div className=" text-2xl font-bold  largePhone:text-3xl">
              Frequently Asked Question
            </div>
            <hr className="h-px w-full border-none bg-neutral-200" />

            <div className="flex w-full flex-col gap-12 largePhone:px-16">
              <Question
