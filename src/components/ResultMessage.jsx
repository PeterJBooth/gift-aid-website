      ...
      {canClaimGiftAid ? (
        ...
        >
          ...
          <img
            src={checkMark}
            alt="check mark"
            className="absolute right-[1.70rem] top-[-2.40rem] largePhone:right-[3.10rem] largePhone:top-[-2.30rem] largeDesktop:right-[3.35rem] largeDesktop:top-[-2.85rem] largeDesktop:w-20"
          />
        </div>
      ) : (
        <div
